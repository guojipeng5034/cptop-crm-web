export default {
  ...
  site: {
    ...
    defaultLang: '默认语言',
    defaultLangPlaceholder: '请输入默认语言',
    availableLangs: '可用语言',
    availableLangsPlaceholder: '请输入可用语言',
    defaultTimeZone: '默认时区',
    defaultTimeZonePlaceholder: '请输入默认时区',
    availableTimeZones: '可用时区列表',
    availableTimeZonesPlaceholder: '请输入可用时区列表',
    search: '搜索',
    reset: '重置',
    export: '导出',
    operate: '操作',
  ...
  versionChecker: {
    ...
    newVersionMessage: '发现新版本 {newVersion}！',
    releaseNotes: '查看更新日志',
    refresh: '立即更新',
    later: '稍后'
  },
