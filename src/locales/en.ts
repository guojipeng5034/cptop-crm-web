export default {
  common: {
    ...
    operateSuccess: 'Operate Succeed',
    operateFail: 'Operate Failed',
    operateCancel: 'Operate Canceled',
    valid: 'Valid',
    invalid: 'Invalid',
  },
  lock: {
  ...
  site: {
    name: 'siteName',
    namePlaceholder: 'Please input Sitename',
    defaultLang: 'defaultLang',
    defaultLangPlaceholder: 'Please input defaultLang',
    availableLangs: 'availableLangs',
    availableLangsPlaceholder: 'Please input availableLangs',
    defaultTimeZone: 'defaultTimeZone',
    defaultTimeZonePlaceholder: 'Please input defaultTimeZone',
    availableTimeZones: 'availableTimeZones',
    availableTimeZonesPlaceholder: 'Please input availableTimeZones',
    search: 'search',
    reset: 'reset',
    export: 'export',
    operate: 'operate',
    ...
    confirm: 'confirm',
    cancel: 'cancel',
    allTimeZone: 'All time zone',
    site: 'site'
  },
  versionChecker: {
    newVersionTitle: 'New Version Available',
    newVersionMessage: 'A new version {newVersion} is available!',
