...
// 学员套餐续费日志 VO
export interface CustomerPackageRenewLogVO {
  id: number //   自增id
...
// 学员套餐续费日志 API
export const CustomerPackageRenewLogApi = {
  // 查询学员套餐续费日志分页
  ...
  // 查询学员套餐续费日志详情
  getCustomerPackageRenewLog: async (packageRenewId: number) => {
    return await request.get({ url: `/crm/packages/customerpackagerenewlog/get?package_renew_id=` + packageRenewId })
  },

  // 新增学员套餐续费日志
  createCustomerPackageRenewLog: async (data: CustomerPackageRenewLogVO) => {
    return await request.post({ url: `/crm/packages/customerpackagerenewlog/create`, data })
  },

  // 修改学员套餐续费日志
  updateCustomerPackageRenewLog: async (data: CustomerPackageRenewLogVO) => {
