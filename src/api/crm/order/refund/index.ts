...
export const RefundApi = {
  ...
  cancelRefund: async (id: number) => {
    return await request.put({ url: `/crm/order/refundrecord/update-invalid?id=` + id })
  },
  ...
  // 更新财务审批退款记录
  updateRefundRecordFapStatus: async (data: RefundVO) => {
    return await request.put({ url: `/crm/order/refundrecord/update-fap`, data })
  },
