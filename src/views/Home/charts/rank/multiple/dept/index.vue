<template>
  <h3 class="text-center m-0">部门排名</h3>
  ...
  <el-card v-for="item in list.rankData.data.multiple.dept" :key="item.id" class="h-10 mb-2 ranking" shadow="always">
...
list.rankData.data.multiple.dept.find((item => item.id === 1)).icon = 'noto:1st-place-medal'
list.rankData.data.multiple.dept.find((item => item.id === 2)).icon = 'noto:2nd-place-medal'
list.rankData.data.multiple.dept.find((item => item.id === 3)).icon = 'noto:3rd-place-medal'
list.rankData.data.multiple.dept
